          ...
          children: [
              ...
              children: [
                ...
                Expanded(
                  child: _buildQuickActionCard(
                    context,
                    'Daily Check-in',
                    _hasCheckedInToday ? 'Completed Today!' : 'How are you feeling?',
                    _hasCheckedInToday ? Iconsax.tick_circle : Iconsax.emoji_happy,
                    _hasCheckedInToday ? Colors.green : Colors.pink,
                    _hasCheckedInToday ? null : () {
                      _showDailyCheckIn();
                    },
                  ),
                ),
            ...
            GridView.count(
              ...
              children: [
                _buildWellnessCard(
                  'Meditation Guide',
                  'Mindfulness exercises for peace',
                  Iconsax.user,
                  Colors.purple,
                  () {
                ...
                _buildWellnessCard(
                  ...
                  Colors.red,
                  () {
                    // Navigate to stress relief
                  },
                ),
                _buildWellnessCard(
                  'Sleep Helper',
                  'Better sleep for better wellness',
                  Iconsax.moon,
                  Colors.indigo,
                  () {
                    // Navigate to sleep helper
                  },
                ),
                _buildWellnessCard(
                  'Mood Tracker',
